...
description: "Install and use 337 agent skills with Gemini CLI. Free evaluation calls, engineering, marketing, and DevOps skills for Google's coding agent."
---

# Gemini CLI Agent Skills Guide

Use 337 production-ready agent skills with Gemini CLI. Every skill in this collection is compatible with Gemini's agent skills specification and installs via the `.gemini/skills/` directory.
...
```json
{
  "name": "claude-skills",
  "version": "2.0.0",
  "description": "337 agent skills for engineering, marketing, product, and more",
...
See the [full catalog](https://github.com/alirezarezvani/claude-skills) for all 337 skills.
