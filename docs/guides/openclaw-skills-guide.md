...
description: "Install and use 337 agent skills with OpenClaw. One-line install for engineering, marketing, product, compliance, and DevOps skills in your OpenClaw workspace."
---

# OpenClaw Skills Guide — Install & Use Agent Skills with OpenClaw

> **Last updated:** June 2026 · **Skills count:** 337 · **Compatibility:** OpenClaw v2024.12+
...
This installs all 337 skills into your OpenClaw workspace with the correct directory structure.
...
*Part of the [Claude Code Skills & Agent Plugins](https://github.com/alirezarezvani/claude-skills) repository — 337 production-ready skills for 13 AI coding tools.*
