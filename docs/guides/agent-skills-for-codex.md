...
description: "Install and use 337 agent skills with OpenAI Codex CLI. Engineering, marketing, product, and DevOps plugins for Codex."
---

# Agent Skills for OpenAI Codex CLI

Use 337 production-ready agent skills with OpenAI Codex CLI. Every skill in this collection works natively with Codex via the `.codex/skills/` directory format.
...
All 337 skills organized by domain:
