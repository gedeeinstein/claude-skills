...
description: "Install and use 337 agent skills with Cursor IDE. Engineering, marketing, and product plugins for Cursor's AI coding agent."
---

# Cursor Agent Skills Guide

Use 337 production-ready agent skills with Cursor IDE. Every skill converts to Cursor's rules format and installs via the `.cursor/skills/` directory.
...
All 337 skills across 17 domains. See the [full README](https://github.com/alirezarezvani/claude-skills) for the complete list.
